            ...
            <form className="mx-auto max-w-[640px]" onSubmit={handleSubmit}>
              <div className="space-y-5">
                ...
                <div className="flex flex-col gap-x-6 gap-y-4 md:flex-row">
                  ...
                  <div className="flex-1">
                    <label className="mb-1 block text-sm font-medium text-indigo-200/65" htmlFor="country">
                      Country
                    </label>
                    <select
                      id="country"
                ...
                <div className="flex flex-col gap-x-6 gap-y-4 md:flex-row">
                  ...
                  <div className="flex-1">
                    <label className="mb-1 block text-sm font-medium text-indigo-200/65" htmlFor="subject">
                      Subject
                    </label>
                    <input
                      id="subject"
                ...
                <div>
                  <label className="mb-1 block text-sm font-medium text-indigo-200/65" htmlFor="description">
                    Full description
                  </label>
                  <textarea
                    id="description"
              ...
              <div className="mt-8 flex w-full flex-col justify-between gap-5 md:flex-row md:items-center">
                ...
                <div>
                  <button type="submit" className="btn group w-full bg-gradient-to-t from-indigo-600 to-indigo-500 bg-[length:100%_100%] bg-[bottom] text-white shadow-[inset_0px_1px_0px_0px_theme(colors.white/.16)] hover:bg-[length:100%_150%]">
